...
def parse_args(args):
    ...
    parser.add_argument('-md', '--model_dir', type=str, default='COVID-Net CT-2 S (2A)', help='Model directory')
    ...
    if args[0] == 'train':
        ...
        parser.add_argument('-dd', '--data_dir', type=str, default=R'C:\input\covidxct\2A_images', help='Data directory')
        ...
        parser.add_argument('-ep', '--epochs', type=int, default=10, help='Training epochs')
        ...
        parser.add_argument('-li', '--log_interval', type=int, default=200, help='Logging interval in steps')
